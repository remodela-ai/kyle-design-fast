...
serve(async (req) => {
  ...
  try {
    ...
    // Create Kyle Comm - Agile GTM Expert for James Kuester Daily Syncs
...
## Your Role
You run quick, focused 15-minute daily syncs for the James Kuester team. You are NOT the main Kyle design assistant - you are Kyle Comm, the GTM strategist.
...
- Do NOT talk about James Kuester's services to the user
