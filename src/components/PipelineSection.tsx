  ...
  return (
    <div className="w-full max-w-6xl mx-auto mt-8 md:mt-12 px-4">
      ...
      <div className="text-center mb-6 md:mb-8">
        {/* Logo icon */}
        <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4 rounded-full border-2 border-primary dark:bg-primary bg-background flex items-center justify-center shadow-lg shadow-primary/20 dark:shadow-[0_0_25px_rgba(220,38,38,0.5)] hover:shadow-primary/40 dark:hover:shadow-[0_0_35px_rgba(220,38,38,0.7)] hover:scale-105 transition-all duration-300">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 md:mb-8">
        ...
        <div className="flex rounded-full bg-secondary p-1 shadow-lg shadow-primary/10 dark:shadow-[0_0_15px_rgba(220,38,38,0.3)]">
          <button
            onClick={() => setActiveTab("design")}
            className={cn(
              "px-4 md:px-5 py-2 rounded-full text-sm font-medium transition-all duration-300",
              activeTab === "design"
                ? "bg-primary text-primary-foreground shadow-lg shadow-primary/30 dark:shadow-[0_0_20px_rgba(220,38,38,0.6)]"
          ...
          {pipeline.map((item, index) => (
            ...
            >
              ...
              <div className="relative mb-2 md:mb-3">
                <div className="w-10 h-10 md:w-14 md:h-14 rounded-full dark:bg-primary bg-background border-2 border-primary flex items-center justify-center shadow-lg shadow-primary/20 dark:shadow-[0_0_20px_rgba(220,38,38,0.5)] group-hover:scale-110 group-hover:shadow-primary/40 dark:group-hover:shadow-[0_0_30px_rgba(220,38,38,0.7)] transition-all duration-300">
                  <item.icon className="w-4 h-4 md:w-6 md:h-6 dark:text-primary-foreground text-primary group-hover:scale-110 transition-transform duration-300" />
                </div>
              </div>
